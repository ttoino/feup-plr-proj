...
The constraint where 4 workers need to be absent every day was not implemented, since it is implicit in the problem domain: with 13 workers and 9 daytime shifts, 4 workers will be absent every day; as for the nighttime shifts, this is also implied since a worker that works during the night must also work during the day and, therefore, must be one of the 9 on-call workers. 
